...
import type { JournalEntry, JournalStatus, SourceType } from '#shared/types/Keuangan'
...
// Saat periode kerja berganti, muat ulang jurnal untuk periode baru.
watch(selectedPeriodId, () => load())

watch([page, limit, statusFilter, sourceTypeFilter], () => load())
