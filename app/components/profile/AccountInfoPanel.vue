...
<template>
  <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
    <div>
      <p class="text-xs font-medium uppercase tracking-wide text-gray-500">Username</p>
      <p class="mt-1 text-sm text-gray-900">{{ user?.username }}</p>
    </div>

    <div>
      <p class="text-xs font-medium uppercase tracking-wide text-gray-500">Nama Lengkap</p>
    ...
    <div>
      <p class="text-xs font-medium uppercase tracking-wide text-gray-500">No. Telepon</p>
      <div class="mt-1 flex flex-wrap items-center gap-2">
    ...
    <div>
      <p class="text-xs font-medium uppercase tracking-wide text-gray-500">Status Akun</p>
    ...
    <div>
      <p class="text-xs font-medium uppercase tracking-wide text-gray-500">Anggota Sejak</p>
      <p class="mt-1 text-sm text-gray-900">{{ formatDate(user?.created_at) }}</p>
    </div>

    <div>
      <p class="text-xs font-medium uppercase tracking-wide text-gray-500">Kata Sandi</p>
